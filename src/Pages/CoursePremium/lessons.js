...
export const lessons = [
  ...
  {
    name: 'Урок номер 2 - Фазы рынка, Скользящие средние, индикатор RSI, Market Profile (Профиль рынка)',
    videoUrl: LESSON_TWO,
    homework: [
      {
  ...
  {
    name: 'Урок номер 3 - Виды ордеров и принципы их сведения, Ценовые уровни и логика их формирования, Объёмы торгов и их влияние на цену, Дельта и кумулятивная дельта в сочетании с ценовыми уровнями',
    videoUrl: LESSON_THREE,
    list: []
  },

  {
    name: 'Урок номер 4 Разворотные свечные модели в сочетании с дельтой, Открытый интерес и его применение, Обьем торгов и его влияние на цену, Сетка Фибоначчи и мифы с ней связанные',
